(function () {
  ...
  function renderOrder() {
    $("#od-kpis").innerHTML = D.order.kpis.map(kpiHtml).join("");
    const o = D.order;
    chart("od-top-order", barOpt("订单维度 TOP5", o.topCustomersOrder.labels, o.topCustomersOrder.values, "#3399ff"));
    chart("od-top-rev", barOpt("收入维度 TOP5", o.topCustomersRev.labels, o.topCustomersRev.values, "#27cc7c"));
    chart("od-pline", pieOpt(o.productLine.labels, o.productLine.values));
    chart("od-form", pieOpt(o.form.labels, o.form.values));
    chart("od-ind", pieOpt(o.industry.labels, o.industry.values));
  }
